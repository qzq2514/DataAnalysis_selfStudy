from pyecharts import Bar,Geo,GeoLines, Style

#Bar图
bar=Bar("我的第一个pyEcharts图表","@qzq2514")
bar.use_theme("light")
bar.add("服装",["衬衫","羊毛纱","雪纺衫","裤子","高跟鞋","袜子"],
        [5,20,34,12,5,45],is_more_utils=True,is_datazoom_show=True)
bar.render("bar.html")
...
data = [
    ...
    ("赤峰", 16),("青岛", 18),("乳山", 18),("金昌", 19),("泉州", 21),("莱西", 21),
     ...
     ("福州", 29),("瓦房店", 30),("即墨", 30),("抚顺", 31),("玉溪", 31),("张家口", 31),   ("阳泉", 31),("莱州", 32),("湖州", 32),("汕头", 32),("昆山", 33),("宁波", 33),
...
geo=Geo("全国城市空气质量","data from pm2.5",title_color="#fff",title_pos="center",width=1200,height=600,
        background_color='#404a59')
attr, value = geo.cast(data)    #将元素是tuple的元素拆开成属性和属性值
geo.add("", attr, value, visual_range=[0, 200], visual_text_color="#fff",
        symbol_size=15, is_visualmap=True)
geo.render("geo1.html")


geo.add("PM", attr, value, type="effectScatter", is_random=True, effect_scale=5)
